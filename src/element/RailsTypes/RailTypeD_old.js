...
function RailTypeD_old({ arrChanges = [], objSettings = {x: 16, y:16}, arrPrew = []}) {
    const ref = useRef();
    ...
    return (
        <instancedMesh ref={ref} args={[null, null,  objSettings.x * objSettings.y * 3]} geometry={nodes.Cube049.geometry} >
            <meshPhongMaterial />
        </instancedMesh>
    );
}
