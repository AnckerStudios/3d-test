...
function NewMacketPage() {
        ...
        <div>  
            ...
            <form className='form3'>
                ...
                <div className='diiv1' ><label>Длина<br/><input className='numbin' type="number" maxLength='3' min = "10" max = "200" placeholder='10'></input></label></div>
                <div className='diiv2'><label>Ширина<br/><input className='numbin' type="number" maxLength='3' min = "10" max = "200" placeholder='10'></input></label><br/></div>
