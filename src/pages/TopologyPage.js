        ...
        <div className="divhome">
            <div className="mx-auto w-full max-w-5xl ">
                <div className="w-full bg-slate-0 flex-col">
                    <div className="w-full flex py-6 px-2">
                        <h4 className="font-bold text-[200%]">
                            {name}
                        </h4>
                    </div>
                    <div className=" w-full flex flex-col md:flex-row gap-y-2 md:gap-y-0 gap-x-4 p-2">
                        <div className=" bg-blue-100 rounded-xl h-96 w-full flex items-center justify-center">

                            <Link className=" border bg-blue-200 hover:bg-blue-300 rounded-xl  p-2 flex justify-center" to={`/topology-editor/${id}/${name}`}>Редактировать</Link>
                        </div>
                    </div>
